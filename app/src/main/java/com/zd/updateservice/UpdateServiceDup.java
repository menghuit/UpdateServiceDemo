...
// */
//@Deprecated
//public abstract class UpdateServiceDup<T> extends Service implements Callable<T>, Dispatcher.Connection<T> {
...
//    public static final int MSG_REQUEST_CHECK = 3;
//
...
//        WeakReference<UpdateServiceDup> refer;
//
//        CheckTask(UpdateServiceDup service){
//            refer = new WeakReference<UpdateServiceDup>(service);
//        }
//
...
//        WeakReference<UpdateServiceDup> service;
//
//        UpdateBinder(UpdateServiceDup service) {
//            this.service = new WeakReference<UpdateServiceDup>(service);
//        }
//
...
//        WeakReference<UpdateServiceDup> service;
//
//        InnerHandler(UpdateServiceDup service){
//            this.service = new WeakReference<UpdateServiceDup>(service);
//        }
//
//        @Override
